...
print('The out of bag score for the multiclass model with outlier removal is ', format(Acc, '.2%'), file=f)
f.close()
...
plt.title('Confusion Matrix for Multiclass Outlier Random Forest Model')
